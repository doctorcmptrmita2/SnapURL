...
<head>
    ...
    <x-seo-meta title="Privacy Policy - SnapURL.to" description="Read SnapURL.to's Privacy Policy. Learn how we protect your data." keywords="snapurl privacy policy, GDPR compliant" canonical="https://snapurl.to/privacy" />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div class="lg:col-span-3">
                    <div class="text-center mb-10">
                        <span class="inline-block px-4 py-1.5 bg-green-50 text-green-600 rounded-full text-sm font-semibold mb-4">Legal</span>
                        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Privacy <span class="brand-text">Policy</span></h1>
                        <p class="text-gray-500">Last updated: {{ date('F d, Y') }}</p>
                    </div>
                    <div class="bg-white rounded-2xl soft-shadow p-8 space-y-6">
                        <p class="text-gray-600 leading-relaxed">At SnapURL.to, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your information.</p>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Data Collection</h2><p class="text-gray-600 mb-3">We collect minimal data:</p><ul class="list-disc list-inside space-y-1 text-gray-600 ml-4"><li>URLs you shorten (stored securely)</li><li>Hashed IP addresses (for analytics)</li><li>Hashed user agents (for device analytics)</li><li>Account information (if you create an account)</li></ul></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Data Usage</h2><p class="text-gray-600">We use collected data solely to provide URL shortening services and analytics. We do not sell or share your data with third parties.</p></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Cookies</h2><p class="text-gray-600">We use cookies for authentication, session management, and advertising. You can disable cookies in your browser.</p></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Third-Party Advertising</h2><p class="text-gray-600">We use Google AdSense to display advertisements. You may opt out of personalized advertising at <a href="https://www.google.com/settings/ads" target="_blank" class="text-orange-600 hover:underline">Google Ads Settings</a>.</p></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Your Rights</h2><p class="text-gray-600 mb-3">Under GDPR, you have the right to:</p><ul class="list-disc list-inside space-y-1 text-gray-600 ml-4"><li>Access your personal data</li><li>Request deletion of your data</li><li>Correct inaccurate data</li><li>Export your data</li></ul><p class="text-gray-600 mt-3">Contact us at <a href="mailto:support@snapurl.to" class="text-orange-600 hover:underline">support@snapurl.to</a>.</p></div>
                    </div>
                </div>
