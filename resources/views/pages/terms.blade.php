...
<head>
    ...
    <x-seo-meta title="Terms of Service - SnapURL.to" description="Read SnapURL.to's Terms of Service." keywords="snapurl terms of service" canonical="https://snapurl.to/terms" />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div class="lg:col-span-3">
                    <div class="text-center mb-10">
                        <span class="inline-block px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-sm font-semibold mb-4">Legal</span>
                        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Terms of <span class="brand-text">Service</span></h1>
                        <p class="text-gray-500">Last updated: {{ date('F d, Y') }}</p>
                    </div>
                    <div class="bg-white rounded-2xl soft-shadow p-8 space-y-6">
                        <p class="text-gray-600 leading-relaxed">By using SnapURL.to, you agree to comply with and be bound by the following terms and conditions.</p>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Acceptable Use</h2><p class="text-gray-600 mb-3">You may not use our service for:</p><ul class="list-disc list-inside space-y-1 text-gray-600 ml-4"><li>Illegal activities or content</li><li>Spam, phishing, or fraudulent activities</li><li>Malware or harmful software distribution</li><li>Copyright infringement</li><li>Harassment or threatening behavior</li><li>Content promoting violence or hate speech</li></ul></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Service Availability</h2><p class="text-gray-600">We strive to maintain 99.9% uptime but do not guarantee uninterrupted service. We reserve the right to suspend accounts that violate these terms.</p></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Account Responsibility</h2><p class="text-gray-600 mb-3">If you create an account, you are responsible for:</p><ul class="list-disc list-inside space-y-1 text-gray-600 ml-4"><li>Maintaining account security</li><li>All activities under your account</li><li>Keeping account information accurate</li></ul></div>
                        <div><h2 class="text-xl font-bold text-gray-900 mb-3">Limitation of Liability</h2><p class="text-gray-600">SnapURL.to is provided "as is" without warranties. We are not liable for any damages resulting from use of our service.</p></div>
